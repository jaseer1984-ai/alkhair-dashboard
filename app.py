...
# =========================================
# AUTO REFRESH (timer-based, no experimental API)
# =========================================
def auto_refresh(seconds: int = 300):
    """
    Trigger a rerun every `seconds` using session_state + time.
    Safe for all Streamlit versions (no experimental APIs).
    """
    now = time.time()
