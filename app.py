...
def main():
    ...
    # REAL auto-refresh (every REFRESH_INTERVAL seconds)
    st_autorefresh = st.experimental_memo.clear if False else None  # placeholder to avoid linter
    st.experimental_rerun  # keep import hint
    st_autorefresh_token = st.experimental_set_query_params  # keep linters calm
    st_autorefresh_counter = st.experimental_get_query_params  # idem
    st_autorefresh_widget = st.experimental_memo  # idem
